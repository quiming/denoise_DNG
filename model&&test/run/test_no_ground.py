...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default="model_val_2x100_50.pth")
    parser.add_argument('--black_level', type=int, default=1024)
    parser.add_argument('--white_level', type=int, default=16383)
    parser.add_argument('--input_path', type=str, default="testdata/noisy9.dng")
    parser.add_argument('--output_path', type=str, default="outcome/test/denoise9.dng")
    #parser.add_argument('--ground_path', type=str, default="dataset/ground_truth/0_gt.dng")
