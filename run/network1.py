...
class Unet(nn.Module):
    def __init__(self, in_channels=4, out_channels=4):
        ...
        self.conv6_1 = Inception(512, 64, (64, 128), (16, 32), 32)
        self.conv6_2 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)
        self.Drop = nn.Dropout(0.5)

        self.upv7 = nn.ConvTranspose2d(256, 128, 2, stride=2)
        self.conv7_1 = Inception(256, 32, (32, 64), (8, 16), 16)
    ...
    def forward(self, x):
        ...
        conv5 = self.leaky_relu(self.conv5_1(conv5))
...
if __name__ == "__main__":
    ...
    test_input = torch.from_numpy(np.random.randn(1, 4, 434, 578)).float().to(device)
    net = Unet().to(device)
    ...
    #              Total number of paramerters in networks is 5538196
